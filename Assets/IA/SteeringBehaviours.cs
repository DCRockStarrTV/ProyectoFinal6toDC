...
public class SteeringBehaviours : MonoBehaviour
{
    public class Seek //----------------------------------------------------------------------------SEEK---------------------------------------------
    {
        ...
        public void Update()
        {
            // Esta wea calcula la dirección hacia el objetivo
    ...
    public class Wander //-------------------------------------------------------------------------WANDER------------------------------------------
    {
        ...
        public void Update()
        {
            ...
            // Esta wea calcula la dirección hacia el punto de deambulación
            Vector3 direction = (wanderCenter + Random.insideUnitSphere * circleDistance - agentTransform.position).normalized;

            // Esta wea calcula el movimiento del agente hacia el punto de deambulación
            Vector3 movement = direction * speed * Time.deltaTime;
